 ...
 *      property settings. Normally you would add @EnableWebMvc for a
 *      Spring MVC app, but Spring Boot adds it automatically when it
 *      sees spring-webmvc on the classpath. This flags the application
 *      as a web application and activates key behaviors such as setting
 ...
 *      to launch an application. There wasn’t a single line of XML?
 *      No web.xml file either. This web application is 100% pure Java and
